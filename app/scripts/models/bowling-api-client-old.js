...
//     email = options.email;
//     password = options.password;
//     var params = angular.extend(requestParams(options), {
//       type: 'POST',
...
//     $.ajax(this.endpoint + '/league', angular.extend(requestParams(options), {
//       type: 'POST',
...
//     $.ajax(this.endpoint + '/bowler', angular.extend(requestParams(options), {
//       type: 'POST',
//       data: JSON.stringify({ name: options.name })
//     }));
//   };
...
//       angular.extend(requestParams(options), {
//         type: 'PUT',
...
//     $.ajax(this.endpoint + '/lottery', angular.extend(requestParams(options), {
//       type: 'POST',
